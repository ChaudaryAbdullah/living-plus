    ...
    <div className="home-page">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p>A Great Platform to Connect users Directly with Property Managers and Discover Your Dream Home</p>
      ...
      <section className="feature-section">
        ...
        <div className="feature-content">
          ...
          <div className="tabs">
            ...
            <button 
              className={activeTab === 'landlords' ? 'tab-btn active' : 'tab-btn'}
          ...
          <p>
            Experience hassle-free rental home searching with our platform. 
            We simplify the process by linking you directly to legit property managers 
          ...
          {properties.map(property => (
            <div className="property-card" key={property.id}>
              <div className="property-image">
                ...
                {property.isPopular && <span className="popular-tag">Popular</span>}
              </div>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                  <path fill={property.isFavorite ? "#FF5A5F" : "none"} 
